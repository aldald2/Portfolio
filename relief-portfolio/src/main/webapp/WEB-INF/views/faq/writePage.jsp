...
<body>
	<div id="wrap">
		<h2 class="marginTop text-center">FAQ 작성</h2>
		<hr>
		<!-- 제목,내용  -->
		<form action="${ contextPath }/faq/insert" method="post" enctype="multipart/form-data">
		<div>
		  <div class="form-group ">
		    <input type="text" class="form-control" placeholder="제목" name="title">
		  </div>
		  <div class="form-group">
		    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="내용" style="resize: none; width:100%; height: 400px;" name="content"></textarea>
		  </div>
		</div>
