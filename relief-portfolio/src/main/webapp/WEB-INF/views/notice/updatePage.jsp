...
<body>
	<div id="wrap">
		<h2 class="marginTop text-center">Notice 수정</h2>
		<hr>
		
		<form action="${ contextPath }/notice/update" method="post" enctype="multipart/form-data">
		<!-- notice_id 히든 값 -->
		...
		<div>
		  <div class="form-group ">
		    <input type="text" class="form-control" placeholder="제목" value="${ notice.title }" name="title">
		  </div>
		  <div class="form-group">
		    <textarea class="form-control" name="ncontent" rows="3" placeholder="내용" style="resize: none; width:100%; height: 400px;">${notice.ncontent}</textarea>
		  </div>
		</div>
		...
		<div class="input-group mb-3">
		  ...
		  <div class="custom-file">
		    ...
		    <c:if test="${ !empty notice.fileName }">
				...
				<input type="hidden" name="rename_fileName" value="${ notice.rename_fileName }">
			</c:if>
		  </div>
		</div>
		...
		<div class="text-right marginTop">
			...
			<button type="submit" class="btn btn-color btsSize marginLeft">수정</button>
